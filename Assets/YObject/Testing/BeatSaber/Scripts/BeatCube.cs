...
public class BeatCube : YMonoBehaviour
{
    ...
    public override void Tick()
    {
        ...
        new ItemCompare(YIDsManager.Instance.GetIdByName(gameObject.GetInstanceID() + ".transform.position.z"), 0, true, true, 1, 20, ItemCompare.Operation.More,
            new YTrigger[] { new ItemEdit(alreadyDone, false, ItemEdit.Operation.Equals, 0) },
            new YTrigger[0]);
